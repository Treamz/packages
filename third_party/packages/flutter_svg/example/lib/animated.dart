...
const Map<String, String> _assets = <String, String>{
  'assets/animated/spinner.svg': 'SMIL: <animateTransform> and <animate>',
  'assets/animated/pulse.svg': 'CSS: @keyframes with transform-origin',
  'assets/animated/orbit.svg': 'SMIL: <animateMotion> along an <mpath>',
};
      ...
      children: <Widget>[
        ...
        Row(
          ...
          children: <Widget>[
            ...
            IconButton(icon: const Icon(Icons.stop), onPressed: _controller.stop),
            Expanded(
